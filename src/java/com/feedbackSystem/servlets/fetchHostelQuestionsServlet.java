...
@WebServlet(urlPatterns = {"/hostelFeedback"})
public class fetchHostelQuestionsServlet extends HttpServlet{
	private static final long serialVersionUID = 1L;
	
	public fetchHostelQuestionsServlet() {
		super();
	}
	...
	protected void doPost(HttpServletRequest request,HttpServletResponse response) 
		...
		else
		{
			...
			try {
					...
					try {
						 newView2 = DBUtils.giveFeedback(conn,"Hostel");
					}catch(Exception e){
		...
		RequestDispatcher dispatcher //
            = this.getServletContext().getRequestDispatcher("/WEB-INF/views/giveHostelFeedbackPage.jsp");
