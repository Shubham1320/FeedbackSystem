...
@WebServlet(urlPatterns = {"/securityFeedback"})
public class fetchSecurityQuestionsServlet extends HttpServlet{
	private static final long serialVersionUID = 1L;
	
	public fetchSecurityQuestionsServlet() {
		super();
	}
	...
	protected void doPost(HttpServletRequest request,HttpServletResponse response) 
		...
		else
		{
			...
			try {
					...
					try {
						 newView2 = DBUtils.giveFeedback(conn,"Security");
					}catch(Exception e){
		...
		RequestDispatcher dispatcher //
            = this.getServletContext().getRequestDispatcher("/WEB-INF/views/giveSecurityFeedbackPage.jsp");
