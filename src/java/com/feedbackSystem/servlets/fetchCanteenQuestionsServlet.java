...
@WebServlet(urlPatterns = {"/canteenFeedback"})
public class fetchCanteenQuestionsServlet extends HttpServlet{
	private static final long serialVersionUID = 1L;
	
	public fetchCanteenQuestionsServlet() {
		super();
	}
	...
	protected void doPost(HttpServletRequest request,HttpServletResponse response) 
		...
		else
		{
			...
			try {
					...
					try {
						 newView2 = DBUtils.giveFeedback(conn,"Canteen");
					}catch(Exception e){
		...
		RequestDispatcher dispatcher //
            = this.getServletContext().getRequestDispatcher("/WEB-INF/views/giveCanteenFeedbackPage.jsp");
