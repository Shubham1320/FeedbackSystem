...
@WebServlet(urlPatterns = {"/libraryFeedback"})
public class fetchLibraryQuestionsServlet extends HttpServlet{
	private static final long serialVersionUID = 1L;
	
	public fetchLibraryQuestionsServlet() {
		super();
	}
	...
	protected void doPost(HttpServletRequest request,HttpServletResponse response) 
		...
		else
		{
			...
			try {
					...
					try {
						 newView2 = DBUtils.giveFeedback(conn,"Library");
					}catch(Exception e){
		...
		RequestDispatcher dispatcher //
            = this.getServletContext().getRequestDispatcher("/WEB-INF/views/giveLibraryFeedbackPage.jsp");
