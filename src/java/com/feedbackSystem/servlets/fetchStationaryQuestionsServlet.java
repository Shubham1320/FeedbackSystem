...
@WebServlet(urlPatterns = {"/stationaryFeedback"})
public class fetchStationaryQuestionsServlet extends HttpServlet{
	private static final long serialVersionUID = 1L;
	
	public fetchStationaryQuestionsServlet() {
		super();
	}
	...
	protected void doPost(HttpServletRequest request,HttpServletResponse response) 
		...
		else
		{
			...
			try {
					...
					try {
						 newView2 = DBUtils.giveFeedback(conn,"Stationary");
					}catch(Exception e){
		...
		RequestDispatcher dispatcher //
            = this.getServletContext().getRequestDispatcher("/WEB-INF/views/giveStationaryFeedbackPage.jsp");
