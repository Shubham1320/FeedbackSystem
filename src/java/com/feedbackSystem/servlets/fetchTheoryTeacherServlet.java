...
@WebServlet(urlPatterns = {"/fetchTeacherForTH"})
public class fetchTheoryTeacherServlet extends HttpServlet{
	private static final long serialVersionUID = 1L;
	
	public fetchTheoryTeacherServlet() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request,HttpServletResponse response) 
		...
		try {
			...
			RequestDispatcher dispatcher = this.getServletContext().getRequestDispatcher("/WEB-INF/views/allocateTeacherForTheorySubjects.jsp");
		...
		{	
			...
			try {
					...
					try {
						...
						newView3 = DBUtils.fetchStudentLoadMapping1(conn,classYear,classDivNo,1,"");
