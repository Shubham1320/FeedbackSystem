...
<div class="wrapper">
        ...
        <form  method="POST" action="${pageContext.request.contextPath}/addTeacher">
                ...
                <input type="text" placeholder="Teacher PRN" name="prnNo" value="${newT.prnNo}" id="TPrnNo" required="required" class="form-control col-md-7 col-xs-12">
				<span style="color:red">* ${firstNameErr} </span>
                <input type="text" placeholder="First Name" name="firstName" value="${newT.firstName}" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                <span style="color:red">* ${middleNameErr} </span>   
                <input type="text" placeholder="Middle Name" name="middleName" value="${newT.middleName}"id="last-name" required="required" class="form-control col-md-7 col-xs-12">
                 <span style="color:red">* ${lastNameErr} </span> 
                <input type="text" placeholder="Last Name" name="lastName" value="${newT.lastName}" required="required" class="form-control col-md-7 col-xs-12">
