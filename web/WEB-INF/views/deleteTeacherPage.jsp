...
<div class="wrapper">
        ...
        <div id="content">
         ...
         <br>       
        <form method="POST" action="${pageContext.request.contextPath}/fetchTeacher">
          <center>
         <br /><br />
                    <br /><br />
                    <br /><br />
                    <div class="col-md-3 col-sm-3 col-xs-6">
                        ...
                        <input type="text" name="T_prnNo"  id="" placeholder="Teacher PRN " required="required" class="form-control col-md-8 col-xs-88" >
                    </div>
                        
                         <br /><br />
                        <br /><br />
                        
                        <button class="btn1 info" style="background-color:#1ABB9C;width:100px;height:50px" type="submit">Fetch</button>
               
        </center>
        </form>
        
         <form method="POST" action="${pageContext.request.contextPath}/deleteTeacher">
          <center>
                    <br /><br />
                    <br /><br />
                       <input type="text" name="T1" style="width:400px" value="${T1}" id="" placeholder="Teacher Name" required="required" class="form-control col-md-8 col-xs-88" > 
                         <br /><br />
                        <br /><br />
                        
                        <button class="btn1 info" style="background-color:#1ABB9C;width:100px;height:50px" type="submit">Delete</button>
                    <br /><br />
                    <br /><br />
         ...
         <a href = "${pageContext.request.contextPath}/welcome1"> <button type="button" class="btn1 info" style="width:100px;height:50px;float:left">Back</button></a>
          </div>
    </div>
