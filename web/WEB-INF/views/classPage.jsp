...
<div class="wrapper">
        ...
        <form  method="POST" action="${pageContext.request.contextPath}/addClass">
            	 ...
            	 <input type="text" placeholder="Department" name="classDept" value="${classDept}" required="required" class="form-control col-md-7 col-xs-12">
				<span style="color:red">* ${classYearErr} </span>
				<input type="text"  placeholder="Class  Year" name="classYear" value="${classYear}" required="required" class="form-control col-md-7 col-xs-12">	        
				<span style="color:red">* ${classDivNoErr} </span>
                <input type="text" placeholder="Class  No" name="classDivNo" value="${classDivNo}" required="required" class="form-control col-md-7 col-xs-12">
