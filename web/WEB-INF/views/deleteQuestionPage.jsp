...
<div class="wrapper">
        ...
        <div id="content">
         ...
         <br>           
           <!-- Ur Page code -->
        <form method="POST" action="${pageContext.request.contextPath}/fetchQuestion">
         <center>
         <br /><br />
                   
                    <input type="text" name="category"  required="required" placeholder="Category" class="form-control col-md-7 col-xs-12">
                     <br /><br />
                        <button class="btn1 info" type="submit" style="background-color:#1ABB9C;width:100px;height:50px">Fetch</button>
                    <br /><br />
        </center>
        </form>
        <form method="POST" action="${pageContext.request.contextPath}/deleteQuestion">
         ...
         <br /><br />
               ...
               <select name="Q1" style="width:559px" class="form-control" required>                      
			 		 <option value="none" selected >Question</option>
			 		<c:forEach items="${question1}" var="question">
        				<option value="${question}">${question}</option>
    				</c:forEach>
				</select>
				<br/><br/>
                        <button class="btn1 info" type="submit" style="background-color:#1ABB9C;width:100px;height:50px">Delete</button>
                    <br /><br />
        </center>
        </form>
