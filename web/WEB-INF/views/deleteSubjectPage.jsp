...
<div class="wrapper">
        ...
        <div id="content">
         ...
         <br>       
        <form method="POST" action="${pageContext.request.contextPath}/deleteSubject">
        	 <center>
         <br /><br />
                    <br /><br />
                    <br /><br />
                     <select name="S1" style="width:559px"  class="form-control" required>                      
				 		<option value="none" selected >Subject</option>
				 		<c:forEach items="${subjectName1}" var="subject1">
