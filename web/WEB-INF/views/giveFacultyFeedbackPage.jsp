...
<div class="header">
  ...
  <div class="info" style="margin-top:20px">
    <h1>FEEDBACK MONITORING SYSTEM</h1>
		...
		<form method="POST"  id="smileys" action="${pageContext.request.contextPath}/submitFacultyFeedback">
			<input style="visibility:hidden" name="feedbackId" value="${feedbackId}">
			<br><br>
