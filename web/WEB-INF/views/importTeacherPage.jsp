...
<div class="wrapper">
        ...
        <div id="content">
           ...
           <!-- Ur Page code -->
        <form method="POST" action="${pageContext.request.contextPath}/importTeacher">
        <center>
         <h2> Import from Excel Sheet</h2>
         <br />
        <br />
        <br />
        <br />   
        <input style="margin-left:75px" type="file" name="filePath" accept="">
        <br />
        <br />
        <br />
        <br />
        <button class="btn btn-success" type="submit" name ="submit">Import Teacher</button>
        <br />
        <br />
        <br />
        <br />
