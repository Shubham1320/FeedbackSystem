...
<div class="wrapper">
        ...
        <form  method="POST" action="${pageContext.request.contextPath}/addStudent">
                    ...
                    <span style="color:red">* ${prnNoErr} </span>
                    <input type="text" name="prnNo" value="${prnNo}" id="prnNo" placeholder="PRN No" required="required" class="form-control col-md-7 col-xs-12">
                    <input type="text"  name="rollNo" value="${rollNo}" id="rollNo" placeholder="Roll No" required="required" class="form-control col-md-7 col-xs-12">
                   <span style="color:red">* ${firstNameErr} </span>
                    <input type="text" id="first-name" name="firstName" value="${firstName}" placeholder="First Name" required="required" class="form-control col-md-7 col-xs-12">
                   <span style="color:red">* ${middleNameErr} </span>
                    <input type="text" name="middleName" value="${middleName}" id="middle-name" placeholder="Middle Name" required="required" class="form-control col-md-7 col-xs-12">
                    <span style="color:red">* ${lastNameErr} </span>
                    <input type="text" name="lastName" value="${lastName}" id="last-name" placeholder="Last Name" required="required" class="form-control col-md-7 col-xs-12">
              
                    <input type="text"  name="password" value="${password}" id="pswd" placeholder="Password" required="required" class="form-control col-md-7 col-xs-12">
                    <span style="color:red">* ${admissionYearErr} </span>
                    <input type="text" name="admissionYear" value="${admissionYear}" id="AdmYear" placeholder="Admission Year" required="required" class="form-control col-md-7 col-xs-12">
                    <span style="color:red">* ${classDeptErr} </span> 
                    <input type="text" name="classDept" value="${classDept}" id="Dept" placeholder="Department" required="required" class="form-control col-md-7 col-xs-12">
                   
                     <select style="width:559px" name="classYear"  class="form-control" required>
                        ...
                        <option value="BE">BE</option>
                         ...
                         <br />
                        <span style="color:red">* ${classDivNoErr} </span>
                    <input type="text" id="Div" name="classDivNo" value="${classDivNo}" placeholder="Div No" required="required" class="form-control col-md-7 col-xs-12">
                            <br />
