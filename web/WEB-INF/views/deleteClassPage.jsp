...
<div class="wrapper">
        ...
        <!-- menu profile quick info -->
            ...
            <ul class="list-unstyled CTAs">
                <li>
                    <a href="${pageContext.request.contextPath}/logOut" class="download">Logout</a>
                </li>
            </ul>
        </nav>
        <!-- Page Content  -->
        ...
        <span style="color:red">${errString} </span>     
         ...
         <br>            
           <!-- Ur Page code -->
        <form method="POST" action="${pageContext.request.contextPath}/deleteClass">
          <center>
         <br /><br />
                    <br /><br />
                    <br /><br />
                    
                    <input type="text"  placeholder="Year" name = "year" required="required" class="form-control col-md-7 col-xs-12">

                    <input type="text"  placeholder="Div No" name = "classNo" required="required" class="form-control col-md-7 col-xs-12">
