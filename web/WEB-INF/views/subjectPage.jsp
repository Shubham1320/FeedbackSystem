...
<div class="wrapper">
        ...
        <form  method="POST" action="${pageContext.request.contextPath}/addSubject">
          		<span style="color:red">* ${subjectIdErr} </span>
                <input type="text" placeholder="Subject ID" name = "subjectId" value="${subjectId}" required="required" class="form-control col-md-7 col-xs-12">
				<span style="color:red">* ${subjectNameErr} </span>
                <input type="text" placeholder="Subject Name" name = "subjectName" value="${subjectName}" required="required" class="form-control col-md-7 col-xs-12">
                <span style="color:red">* ${subjectCategoryErr} </span>   
                <input type="text"  placeholder="Subject Category" name = "subjectCategory" value="${subjectCategory}" required="required" class="form-control col-md-7 col-xs-12">
                <span style="color:red">* ${classYearErr} </span>  
                <select name="classYear" style="width:559px" class="form-control" required>                      
			 		<option value="none" selected >Year</option>
			 		<c:forEach items="${classYears}" var="classY">
				...
				<select name="classDivNo" style="width:559px" class="form-control" required>                      
			 		...
			 		<c:forEach items="${classDivNos}" var="classDiv">
        				<option value="${classDiv}">${classDiv}</option>
    				</c:forEach>
				</select>  
                            <br />
